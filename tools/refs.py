...
cuesta caro creerselo. Dos formas de equivocarse, las dos vistas en este mismo
juego:

  - Una tira de bytes repetidos parece un puntero. Donde hay `6e 6e 6e 6e`,
    leido como palabras sale 0x6E6E; en la zona de la pista aparecian asi 208
    "punteros internos" que no existen.
  - Leer desde el byte de en medio de una instruccion inventa direcciones. En
    0x4849 hay `ld bc,0180h`, y empezando a leer un byte mas alla sale un
    `ld bc,703Eh` que nadie escribio nunca.
