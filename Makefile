...
imagenes: $(ROM)
	...
	python3 tools/render_tiles.py work/vram.bin docs/imagenes $(ROM)
	...
	python3 tools/render_foca.py $(ROM) work/vram.bin docs/imagenes | tail -3
	python3 tools/render_pinguino.py $(ROM) work/vram.bin docs/imagenes | tail -1
